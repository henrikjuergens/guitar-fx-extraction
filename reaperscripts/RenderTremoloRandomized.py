...
RPR_RENDER_PATH = Path('D:/Henrik/Eigene Aufnahmen/ReaperProjekte/TremoloRandomized')
DIST_FX_SLOT = 0
...
def render_files(file_name):
  ...
  param_val_file = str(RPR_RENDER_PATH) + '\\' 'CurrentDir' + '\\' + file_name[:-4] + '-TremRnd' + '.pickle'
